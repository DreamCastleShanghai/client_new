...
FNoticeManager::FNoticeManager()
{
    ...
    const char *sql_createtable = "CREATE TABLE IF NOT EXISTS notice(id int auto_increment, sid int, title VARCHAR(256), readed int, start_time int64, end_time int64);";
	sqlite3_stmt *stmt;
